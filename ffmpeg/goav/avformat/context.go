...
func (f *FormatContext) AvformatFreeContext() {
	C.avformat_free_context((*C.struct_AVFormatContext)(f))
}

// Add a new stream to a media file.
func (f *FormatContext) AvformatNewStream(c *avcodec.Codec) *Stream {
	return (*Stream)(C.avformat_new_stream((*C.struct_AVFormatContext)(f), (*C.struct_AVCodec)(unsafe.Pointer(c))))
}
...
func (f *FormatContext) AvformatFindStreamInfo(d **avutil.Dictionary) int {
	return int(C.avformat_find_stream_info((*C.struct_AVFormatContext)(f), (**C.struct_AVDictionary)(unsafe.Pointer(d))))
}
...
func (f *FormatContext) AvReadFrame(pkt *avcodec.Packet) int {
	return int(C.av_read_frame((*C.struct_AVFormatContext)(unsafe.Pointer(f)), toCPacket(pkt)))
}
...
func (f *FormatContext) AvformatCloseInput() {
	C.avformat_close_input((**C.struct_AVFormatContext)(unsafe.Pointer(&f)))
}
...
func (f *FormatContext) AvInterleavedWriteFrame(pkt *avcodec.Packet) int {
	return int(C.av_interleaved_write_frame((*C.struct_AVFormatContext)(f), toCPacket(pkt)))
}
...
func (f *FormatContext) AvWriteTrailer() int {
	return int(C.av_write_trailer((*C.struct_AVFormatContext)(f)))
}
