...
func NewH264FromConfig(config *H264Config) (codecs.Codec, error) {
...
func (h *H264) MimeType() string {
	return pion.MimeTypeH264
}

func (h *H264) Type() codecs.CodecType {
	return Type{}
}

func (h *H264) Clone() codecs.Codec {
	return &H264{
...
func (h *H264) SetCodecContext(codecCtx *avcodec.CodecContext) {
	codecCtx.SetCodecID(h.Type().AVCodecID())
	codecCtx.SetCodecType(h.Type().AVMediaType())
